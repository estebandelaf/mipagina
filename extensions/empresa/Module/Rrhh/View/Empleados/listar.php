...
<p>Listado de empleados de la empresa.</p>
...
foreach($Empleados as &$obj) {
	...
	$row[] =
		...
		'<a href="'.$_base.$module_url.$controller.'/eliminar/'.urlencode($obj->run).'" title="Eliminar" onclick="return eliminar(\'Empleado\', \''.$obj->run.'\')"><img src="'.$_base.'/img/icons/16x16/actions/delete.png" alt="" /></a>';
	$data[] = $row;
}

...
foreach($Proveedores as &$obj) {
	...
	$row[] =
		...
		'<a href="'.$_base.$module_url.$controller.'/eliminar/'.urlencode($obj->rut).'" title="Eliminar" onclick="return eliminar(\'Proveedor\', \''.$obj->rut.'\')"><img src="'.$_base.'/img/icons/16x16/actions/delete.png" alt="" /></a>';
	$data[] = $row;
}

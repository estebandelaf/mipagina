...
foreach($Sucursales as &$obj) {
	...
	$row[] =
		...
		'<a href="'.$_base.$module_url.$controller.'/eliminar/'.urlencode($obj->id).'" title="Eliminar" onclick="return eliminar(\'Sucursal\', \''.$obj->id.'\')"><img src="'.$_base.'/img/icons/16x16/actions/delete.png" alt="" /></a>';
	$data[] = $row;
}

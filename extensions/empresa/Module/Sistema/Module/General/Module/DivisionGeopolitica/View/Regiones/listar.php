...
foreach($Regiones as &$obj) {
	...
	$row[] =
		...
		'<a href="'.$_base.$module_url.$controller.'/eliminar/'.urlencode($obj->codigo).'" title="Eliminar" onclick="return eliminar(\'Region\', \''.$obj->codigo.'\')"><img src="'.$_base.'/img/icons/16x16/actions/delete.png" alt="" /></a>';
	$data[] = $row;
}
